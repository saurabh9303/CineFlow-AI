            ...
            <div className="mb-16 text-center">
               ...
               <div className="flex flex-col sm:flex-row gap-4 justify-center mt-5">
                  ...
                  <button
                     ...
                     className="px-8 py-2 rounded-2xl bg-gradient-to-r from-cyan-500 to-blue-600 font-semibold text-lg hover:scale-105 transition-all duration-300 disabled:opacity-50"
                  >
                     {
                        checkingAuth
                           ? "Checking login..."
                  ...
                  <button
                     ...
                     disabled={!user}
                     className="px-8 py-2 rounded-2xl border border-white/10 bg-white/5 hover:bg-white/10 transition-all duration-300 font-semibold"
                  >
                     🎥 My Videos
                  </button>
